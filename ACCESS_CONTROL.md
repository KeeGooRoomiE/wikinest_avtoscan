...
- Структурным операциям с деревом — создание/переименование/удаление папки, тумблер «Редактировать структуру» (реордер — только на VM-пути, см. [BACKEND_ARCHITECTURE.md](BACKEND_ARCHITECTURE.md#удаление-переименование-реордер-папок-2026-07))
